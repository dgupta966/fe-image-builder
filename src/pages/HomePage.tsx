  ...
  const features = [
    {
      ...
      description: 'Connect your Google Drive and access all your images seamlessly',
    },
    {
      icon: <AutoAwesome sx={{ fontSize: { xs: 40, sm: 48 } }} />,
      title: 'AI-Powered Optimization',
      description: 'Smart compression that maintains quality while reducing file size',
    },
    {
  ...
  const sampleImages = [
    {
      ...
      description: 'Transform your high-resolution photos with AI-powered optimization',
      beforeSize: '5.2 MB',
      afterSize: '1.1 MB',
    },
    {
      ...
      description: 'Optimize web images for faster loading times and better performance',
      beforeSize: '3.8 MB',
      afterSize: '680 KB',
    },
    {
      ...
      description: 'Create stunning thumbnails and marketing visuals with AI assistance',
      beforeSize: '4.5 MB',
      afterSize: '890 KB',
    },
    {
    ...
    },
    {
      ...
      description: 'Perfect your social media images with smart compression and resizing',
      beforeSize: '2.9 MB',
      afterSize: '520 KB',
    },
  ];
  ...
  return (
    <Box sx={{ width: '100%', minHeight: '100vh' }}>
        ...
        <Toolbar sx={{ justifyContent: 'space-between', py: 1, px: { xs: 2, sm: 3 } }}>
          <Typography 
            ...
            sx={{ 
              ...
              WebkitBackgroundClip: theme.palette.mode === 'dark' ? 'unset' : 'text',
              WebkitTextFillColor: theme.palette.mode === 'dark' ? '#FFFFFF' : 'transparent',
        ...
        <Container maxWidth="md" sx={{ position: 'relative', zIndex: 1 }}>
          <Typography
            ...
            sx={{
              ...
              background: theme.palette.mode === 'dark' 
                ? 'linear-gradient(45deg, #FFFFFF 30%, #EDE9FE 90%)'
                : 'linear-gradient(45deg, #6D28D9 30%, #8B5CF6 90%)',
      ...
      <Container maxWidth="xl" sx={{ py: { xs: 8, md: 12 } }}>
        ...
        >
          Everything you need to optimize images and create professional thumbnails
        </Typography>
